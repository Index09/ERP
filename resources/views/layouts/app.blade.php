...
<body class="app sidebar-mini rtl ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown  d-flex">
                                            <a onclick='settheme()' class="nav-link icon theme-layout nav-link-bg layout-setting">
                ...
                <div  class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="/home"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">لوحه التحكم</span></a>
                            </li>
                           
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">المبيعات</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="/sellorders" class="slide-item"> المبيعات</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="javascript:void(0)"><span class="sub-side-menu__label">امر بيع</span><i class="sub-angle fe fe-chevron-right"></i></a>
                                        <ul class="sub-slide-menu">
                                            <li><a href="/sellorder" class="sub-slide-item">كاش </a></li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-package"></i><span class="side-menu__label">المشتريات</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">                    
                                    <li><a href="dropdown.html" class="slide-item"> المشتريات</a></li>
                                    <li><a href="dropdown.html" class="slide-item"> امر شراء</a></li>
                                    <li><a href="dropdown.html" class="slide-item">طلب مورد</a></li>
                                </ul>
                            </li>
                            <li class="sub-category">
                                <h3>المؤسسه</h3>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">العملاء</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="/customers" class="slide-item"> العملاء</a></li>
                                    <li><a href="/customer" class="slide-item">اضافه عميل</a></li>
                                    <li><a href="/customeraccouning" class="slide-item">حساب العملاء</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon  fe fe-users"></i><span class="side-menu__label">المورديين</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="/suppliers" class="slide-item"> المورديين</a></li>
                                    <li><a href="/supplier" class="slide-item"> اضافه مورد</a></li>
                                    <li><a href="shop-description.html" class="slide-item">حساب المورديين</a></li>
                                </ul>
                            </li>
                    
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-shopping-bag "></i><span class="side-menu__label">المخازن</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)"></a></li>
                                    <li><a href="/invintory" class="slide-item">اضافه مخزن</a></li>
                                    <li><a href="/invintoriesview" class="slide-item">المخازن</a></li>
                                    <li><a href="/invintorygrid" class="slide-item">جرد المخازن</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">المنتجات</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)"></a></li>
                                    <li><a href="/productsview" class="slide-item"> المنتجات</a></li>
                                    <li><a href="/product" class="slide-item">اضافه منتج</a></li>                      
                                </ul>
                            </li>
        
        
                            <li class="sub-category">
                                <h3>محاسبه وتقارير</h3>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-map-pin"></i><span class="side-menu__label">محاسبه</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="maps1.html" class="slide-item">الصادرات</a></li>
                                    <li><a href="maps.html" class="slide-item">الواردات</a></li>
                                    <li><a href="maps.html" class="slide-item">التكاليف</a></li>
                                    <li><a href="maps.html" class="slide-item">المخزون</a></li>
                                    <li><a href="maps.html" class="slide-item">المستندات</a></li>
                                    <li><a href="maps.html" class="slide-item">الارباح</a></li>
                                    <li><a href="maps.html" class="slide-item">تقارير</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-wind"></i><span class="side-menu__label">التقارير</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">التقارير</a></li>
                                    <li><a href="chart-chartist.html" class="slide-item">المراكز الطبيه</a></li>
                                    <li><a href="chart-flot.html" class="slide-item">الاطباء</a></li>
                                    <li><a href="chart-echart.html" class="slide-item"> الفروع</a></li>
                                    <li><a href="chart-morris.html" class="slide-item">الشركات</a></li>
                                    <li><a href="chart-nvd3.html" class="slide-item">التحاليل</a></li>
                                    <li><a href="charts.html" class="slide-item">الموظفين</a></li>
                                    <li><a href="chart-line.html" class="slide-item">المرضى</a></li>
                                    <li><a href="chart-donut.html" class="slide-item"> تقارير شامله</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-wind"></i><span class="side-menu__label">اعدادات</span><i class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">اعدادات</a></li>
                                    <li><a href="icons.html" class="slide-item">شكل  النظام</a></li>
                                    <li><a href="icons2.html" class="slide-item">الللغه</a></li>
                                    <li><a href="icons3.html" class="slide-item">اكواد خصم</a></li>
                                    <li><a href="icons4.html" class="slide-item">القوالب</a></li>
                                    <li><a href="icons5.html" class="slide-item">الضريبه</a></li>
                                    <li><a href="icons6.html" class="slide-item">الزياره المنزليه</a></li>
                                    <li><a href="icons7.html" class="slide-item"> الجنسيات</a></li>
                                    <li><a href="icons9.html" class="slide-item">العروض</a></li>
                                    <li><a href="icons10.html" class="slide-item">الموظ</a></li>
    ...
    <script>
        ...
        document.querySelector('body').classList.add(localStorage['mode'])
