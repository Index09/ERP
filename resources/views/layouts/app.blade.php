...
<body class="app sidebar-mini rtl ">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="/home"><i
                                        class="side-menu__icon fe fe-home"></i><span class="side-menu__label">لوحه
                                        التحكم</span></a>
                            </li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">المبيعات</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="/sellorders" class="slide-item"> المبيعات</a></li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                            href="javascript:void(0)"><span class="sub-side-menu__label">امر
                                                بيع</span><i class="sub-angle fe fe-chevron-right"></i></a>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">المشتريات</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">العملاء</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">المورديين</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">المخازن</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">محاسبه</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="maps1.html" class="slide-item">الصادرات</a></li>
                                    <li><a href="/income" class="slide-item">الايردات</a></li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-wind"></i><span
                                        class="side-menu__label">اعدادات</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
    ...
    <!-- BACK-TO-TOP -->
    <a href="#top" id="back-to-top"><i class="fe fe-angle-up"></i></a>
    ...
    <script>
        //     var pusher = new Pusher('a169707b8c46e5d245fb', {
        //             encrypted: false,
        //             cluster: "eu",
        //         });
        ...
        //    document.getElementById('msgbody1').innertext = data.msg
        //      $('#modaldemo85').modal('show');
        //     });
