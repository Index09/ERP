    ...
    <div class="col-md-12 col-xl-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">امر بيع</h3>
            </div>
            <div class="card-body">
                            ...
                            <table class="table border text-nowrap text-md-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <tr > 
                                        ...
                                        <td><input v-model="overall" type="text" class="form-control"></td>
                                        <td><input :value="overall - paied ? overall - paied :0 " type="text" class="form-control"></td>
